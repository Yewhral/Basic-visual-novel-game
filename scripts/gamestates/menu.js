let menuState = {
  ...
  create:function(){
      ...
      let gameDetailsButton = game.add.button(0.167*this.game.width,0.3888*this.game.height,'mainMenuButton',this.aboutGame,this,1,2,0);
      let authorButton = game.add.button(0.167*this.game.width,0.58333*this.game.height,'mainMenuButton',this.aboutAuthor,this,1,2,0);
